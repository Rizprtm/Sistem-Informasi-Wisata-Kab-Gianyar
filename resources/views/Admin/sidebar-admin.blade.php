...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="/dashboard/berita" aria-expanded="false" aria-controls="tables">
      ...
      <li class="nav-item {{ Request::is('dashboard/destinasi') ? 'active' : ''}}">
        <a class="nav-link" href="/dashboard/destinasi" aria-expanded="false" aria-controls="form-elements">
