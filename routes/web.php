...
*/
    ...
    Route::group(['middleware' => ['isLogin'],'prefix' => 'dashboard'], function() {
        ...
        Route::get('/logactivity','App\Http\Controllers\dashboard@logactivity')->name('logactivity');
    ...
    Route::get('/login','App\Http\Controllers\C_Session@index')->name('login.index')->middleware('isAdmin');
    Route::get('/login/logout','App\Http\Controllers\C_Session@logout')->name('logout.index');
    Route::post('/login/aksi','App\Http\Controllers\C_Session@login')->name('aksi.index');
